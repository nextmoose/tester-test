                      ...
                      let
                        in
                          [
                            ...
                            ( tester : tester ( testee : let x = builtins.typeOf ( builtins.getAttr "buildInput" ( builtins.getAttr "devShell" ( testee implementation test ) ) ) ; in builtins.trace x x ) true "buildInputs" )
                          ] ;
              }
          ) ;
  }