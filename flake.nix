			...
			in
		          {
		            ...
		            happy3 = tester : tester "b7f9625b-02c0-4b98-9b4b-0fefdd7d1640" ( testee : testee implementation test ) true { devShell = pkgs.mkShell { } ; } ;
		            happy4 = tester : tester "d2385cdb-418e-42e5-8f74-8abe92ee5552" ( testee : testee implementation test ) false null ;
		          } ;
	      }
	  ) ;
  }